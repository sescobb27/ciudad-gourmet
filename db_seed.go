...
var (
        categoriesSeed = []string{"Pasta", "Carne", "Pollo", "Ensalada", "Desayuno",
        ...
        descriptionsSeed = []string{"Ricas Pasta", "Ricas Carnes", "Rico Pollo",
        ...
        locationsSeed = []string{"Poblado", "Laureles", "Envigado", "Caldas",
...
var (
        u_names      = []string{"Simon", "Edgardo", "Juan", "Camilo"}
        u_last_names = []string{"Escobar", "Sierra", "Norenia", "Mejia"}
        ...
        u_passwords = []string{"qwerty", "123456", "AeIoU!@",
                "S3CUR3P455W0RD!\"#$%&/()="}
)
...
var (
        ...
        p_descriptions = []string{"Descripcion1", "Descripcion2",
                "Descripcion3", "Descripcion4"}
        p_prices         = []float64{18500.0, 12300.0, 5000.0, 7300.0}
        p_image  string  = "images/default.png"
        p_rates          = []float32{1.9, 2.5, 3.2, 4.8}
)
